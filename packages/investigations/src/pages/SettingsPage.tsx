    ...
    return (
        <Card>
            ...
            <CredentialStorageInfo>
                ...
                <p>
                    In local development mode, keys are read from the <code>SENTINEL_MESH_API_KEY</code> environment
                    variable. Plaintext key storage is refused unless <code>SENTINEL_MESH_DEV_MODE=1</code> is also set.
                </p>
                <p>
