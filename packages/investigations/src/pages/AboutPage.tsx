...
const AboutPage: React.FC = () => (
    <Card>
        <Title>Sentinel Mesh</Title>
        <Tagline>From alert to evidence-backed response in minutes.</Tagline>

        <SectionTitle>What Sentinel Mesh Does</SectionTitle>
        <Body>
            Sentinel Mesh is an agentic SOC investigation copilot embedded in Splunk. A SOC analyst describes an
            alert — a host, a user, a suspicious behavior — and Sentinel Mesh launches a multi-step investigation
        ...
        <Body>
            Sentinel Mesh uses a configurable LLM provider (Anthropic Claude, OpenRouter, or any OpenAI-compatible
        ...
        <Body>
            Sentinel Mesh never takes automated response actions. All response recommendations require explicit
        ...
        <Body>
            Sentinel Mesh requires a Python backend service to run agents and LLM calls. In production, this is
        ...
        <BulletList>
            ...
            <li>
                <InlineCode>uvicorn sentinel_mesh.app:app --reload --port 8000</InlineCode>
            </li>
        </BulletList>
        <Body>
            Configure your LLM provider on the Settings tab. Set <InlineCode>SENTINEL_MESH_API_KEY</InlineCode>{' '}
